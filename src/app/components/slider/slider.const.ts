...
export const SLIDER_DATA: ICarouselItem []=[
    {
        id: 1,
        title: {
            first: 'CHAT',
    ...
    //         second: ''
    //     },
    //     subtitle: 'The portfolio you are looking at has been created with Node, Mongodb, Express, Angular 16, ThreeJS, GSAP, NodeMailer, BootStrap, etc. It has been deployed with Linux, using VPS, SSH, Ngnx, Pm2, in addition, it has high security standards implementing SSL certificates, and everything has been registered in a repository Using Git and GitHub.',
    //     link: '/',
    //     image: '',
    // }
];